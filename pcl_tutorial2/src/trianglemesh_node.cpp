...
public:
  ...
  TriangleMeshNode()
  {
    ...
    pub_ = nh_.advertise<pcl_msgs::PolygonMesh>("pcl_meshtriangle",10); // set tpoic name to publish
    ...
    // rosbag file. /camera/depth/points
    sub_ = nh_.subscribe ("pf_out2", 1,  &TriangleMeshNode::cloudCallback, this); 
